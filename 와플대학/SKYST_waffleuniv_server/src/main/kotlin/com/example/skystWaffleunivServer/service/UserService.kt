...
class UserService(
    ...
    fun joinRoom(userId: Long): RoomAssignment {
        ...
        return RoomAssignment(
            ...
            currentSong = target.currentSong?.let { SongPlayDto.fromEntity(it) },
    ...
    fun getRoomInfo(userId: Long): RoomAssignment {
        ...
        return RoomAssignment(
            ...
            currentSong = room.currentSong?.let { SongPlayDto.fromEntity(it) },
    ...
    data class RoomAssignment(
        ...
        val userCount: Int,
        val songCount: Int,
        val currentSong: SongPlayDto? = null,
